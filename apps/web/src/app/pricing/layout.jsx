export const metadata = {
  ...
  description:
    'Transparent per-term pricing for Kenyan CBC schools. KES 7,500 base fee plus KES 40 per enrolled student per term. No hidden fees, no tier cliffs. 30-day free trial.',
  openGraph: {
    ...
    offers: [
      {
        ...
        price: '7500',
        priceCurrency: 'KES',
        description: 'KES 7,500/term base fee + KES 40 per student. Full CBC features for emerging schools.',
      },
      {
        '@type': 'Offer',
        ...
        price: '7500',
        priceCurrency: 'KES',
        description: 'KES 7,500/term base fee + KES 40 per student. Most popular plan for expanding Kenyan schools.',
      },
      {
        '@type': 'Offer',
        ...
        price: '7500',
        priceCurrency: 'KES',
        description: 'KES 7,500/term base fee + KES 40 per student. Priority support and advanced analytics for large schools.',
      },
    ],
  },
};
