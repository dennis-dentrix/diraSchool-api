  ...
  return (
    <section className="relative overflow-hidden bg-slate-950 py-24 px-4 sm:px-6 text-center">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        <p className="mt-4 text-xs text-slate-600">No credit card required · Unlimited students during trial · Full features</p>
      </div>
    </section>
  );
}
              ...
              >
                ...
                {!plan.custom && (
                  <div className={cn('mt-4 rounded-lg p-3 text-xs space-y-1', plan.highlight ? 'bg-white/10' : 'bg-slate-50')}>
                    ...
                    <div className={cn('flex justify-between pt-1 border-t', plan.highlight ? 'text-blue-100 border-white/20' : 'text-slate-500 border-slate-200')}>
